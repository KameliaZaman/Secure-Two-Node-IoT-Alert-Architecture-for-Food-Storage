...
// ---------------------------------------------------------
// DEVICE CONFIG (LOW HUMIDITY STORAGE)
// ---------------------------------------------------------
#define DEVICE_ID "ESP32_L"

#define DHTPIN 26
#define DHTTYPE DHT11

#define LED_WHITE 32   // WHITE LED → too dry (ALERT_LOW)
#define LED_RED   33   // RED LED   → too humid (ALERT_HIGH)
#define BUTTONPIN 27
...
const char* mqtt_server = "10.183.112.4";
...
void loop() {
  ...
  // SEND STATUS EVERY 4 seconds (test timing)
  if (now - lastMsg > 4000) {
    lastMsg = now;
  ...
  // ✔ EDGE-TRIGGERED ACK BUTTON (fixed)
